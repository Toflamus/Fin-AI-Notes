...
文献驱动的研究笔记。每读一篇论文或做一次调研，在这里留下一份结构化的笔记。
...
1. **一句话总结** — 这篇在说什么
2. **核心贡献 / 核心发现** — 3-5 个要点
3. **关键公式与推导** — 完整保留，不省略中间步骤
4. **A 股适用性 / 实战落地** — 在 A 股环境下是否适用、如何修正
5. **与知识库其他内容的关联** — 交叉引用
6. **待深入的问题** — 读完后产生的新问题，指导下一步阅读
...
- [x] Cont, Kukanov, Stoikov (2014) — OFI 基础理论 → 笔记在 [Microstructure/OFI_VOI.md](../Microstructure/OFI_VOI.md)
- [x] Kyle (1985) — 三模型完整推导 → 笔记在 [Microstructure/KyleModel_Derivation.md](../Microstructure/KyleModel_Derivation.md)
- [x] Easley, López de Prado, O'Hara (2012) — VPIN → 笔记在 [Microstructure/PIN_VPIN.md](../Microstructure/PIN_VPIN.md)
...
- [ ] Cont, Kukanov, Stoikov (2014) — *The Price Impact of Order Book Events* — 原文精读
- [ ] Kyle (1985) — *Continuous Auctions and Insider Trading* — 原文精读
- [ ] Multi-Level OFI (Xu et al. 2019) — *Multi-Level Order-Flow Imbalance in a Limit Order Book*
- [ ] DeepLOB (Zhang et al. 2019) — *Deep Convolutional Neural Networks for Limit Order Books*
- [ ] Almgren & Chriss (2000) — 最优执行模型
- [ ] Obizhaeva & Wang (2013) — 订单簿恢复力模型
